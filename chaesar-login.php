            ...
            <form class="mt-8 space-y-6" action="" method="POST">
                ...
                <div class="rounded-md shadow-sm -space-y-px">
                    ...
                    <div>
                        ...
                        <input id="key" name="key" type="text" autocomplete="key" required class="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-b-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm" placeholder="key" maxlength="2">
                    </div>
                </div>
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="text-sm">
                        <a href="chaesar-register.php" class="font-medium text-indigo-600 hover:text-indigo-500"> Sing up</a>
                    </div>
                </div>
